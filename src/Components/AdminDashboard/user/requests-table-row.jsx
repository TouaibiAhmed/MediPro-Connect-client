  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
        ...
        <TableCell>{doctor.adresseCabinet}</TableCell>
        <TableCell>
          <FormControl fullWidth>
            ...
            <Select
              ...
              fullWidth
            >
              <MenuItem value="activé">Accept</MenuItem>
              <MenuItem value="en attente">Decline</MenuItem>
            </Select>
          </FormControl>
        </TableCell>
        <TableCell>
...
UserTableRow.propTypes = {
  ...
  doctor: PropTypes.shape({
    ...
    adresseCabinet: PropTypes.string
  }),
